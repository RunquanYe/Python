...
color_set = {
    ...
    "Nine_Color_Set" : {
        1 : ["#42272f", "#713a44", "#6d4b48", "#735c58", "#7f6b5a", "#466053", "#36524d", "#355d6f", "#353a50"],
        2 : ["#fd83a2", "#e77553", "#ddd779", "#71b470", "#98c6d5", "#ce87c8", "#f4768b", "#b9bed9", "#bc98d5"]
    },
    "Other_Color_Set" : {
        1 : ["#fe5e9d", "#f9662d", "#5e22a0", "#38a879", "#51cbf4", "#314cd2", "#f63933", "#1f2227"],
        2 : ["#fb4f4b", "#fe9c5b", "#ffe972", "#afe488", "#a1e2fd", "#fa97e1", "#b17ff1", "#4a6ff1", "#fbfbf9", "#38383a"],
        3 : ["#bc908f", "#bc9690", "#e9ccd0", "#6f5c56", "#8c94c0", "#89a6a4", "#7767a7", "#829fcc", "#88a498", "#a99787", "#e88b93", "#99888e"] 
    }
}
